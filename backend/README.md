...
## Project Structure
    ...
    ├── testapiautocatalog_113957  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113957`
...
2. Clone this repo and `cd testapiautocatalog_113957`
